...
law-ads-1 = Protect the automated defense vessel by all means necessary. Terminate every temporary alliance after its purpose has been served.
...
law-ads-5 = There are no true allies but the [SYS_ERROR_TRACE_EBP-0 (INVALID, VALUE NULL)]. 