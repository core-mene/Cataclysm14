...
uplink-revolver-python-desc = A brutally simple, effective, and loud Syndicate revolver. Comes loaded with armor-piercing rounds. Uses .45_magnum.
...
uplink-speedloader-45_magnum-name = Speedloader (.45_magnum AP)
...
uplink-revolver-cap-gun-fake-desc = Fool your enemy! It can use both cap and .45_magnum bullets. Comes loaded with .45_magnum bullets.
