...
job-description-deputy = Hunt down ASR insurgents and enemies of the TSF, enforce the Colonel's law, and bring order to chaos in the sector.
...
job-description-pirate = You are a member of an insurgency cell against the TSF expansion into the Colossus sector.
job-description-pirate-captain = You are the leader of an insurgency cell against the TSF expansion into the Colossus sector.
...
job-description-senior-officer = Teach new privates the basics of counter-insurgency, and lead your TSFMC squads to victory against the ASR.
